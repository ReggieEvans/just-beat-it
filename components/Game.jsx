    ...
    <div className='flex flex-col mb-4 mx-4 w-[150px] text-sm'>
      <div className='relative'>
        ...
        <div className='absolute top-0 right-0 -mr-4 flex flex-col items-center'>
          ...
          {game._isInProgress && (
            <div className='h-[12px] w-[12px] bg-sky-400 rounded-full mb-2'></div>
          )}

          {game._isPileOfShame && (
            <div className='h-[12px] w-[12px] bg-orange-600 rounded-full mb-2'></div>
          )}

          {game._isQuit && (
            <div className='h-[12px] w-[12px] bg-rose-600 rounded-full mb-2'></div>
          )}
        </div>
